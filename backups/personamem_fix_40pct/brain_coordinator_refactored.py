        ...
        if self.preference_aware_retrieval and result.memories:
            try:
                ...
                if pref_result.boost_applied:
                    ...
                    logger.debug(f"Preference boost applied: {len(pref_result.preference_memories)} preference memories")
            ...
            if self.persona_memory:
                try:
                    ...
                    if needs_persona:
                        ...
                        persona_result = await self.persona_memory.retrieve_persona(user_input, k=8)
