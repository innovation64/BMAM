...
ABLATION_PRESETS: Dict[str, AblationConfig] = {
    ...
    # === 成对组合消融 (验证协同效应) ===
    'no_prefrontal_temporal': AblationConfig(
        name='no_prefrontal_temporal',
        description='禁用前额叶+颞叶 (验证执行-语义协同)',
        enable_prefrontal=False,
        enable_temporal_lobe=False,
        enable_kg=False  # 颞叶负责KG巩固
    ),

    'no_hippocampus_amygdala': AblationConfig(
        name='no_hippocampus_amygdala',
        description='禁用海马体+杏仁核 (验证编码-显著性协同)',
        enable_hippocampus=False,
        enable_amygdala=False,
        enable_salience=False
    ),

    'no_hippocampus_temporal': AblationConfig(
        name='no_hippocampus_temporal',
        description='禁用海马体+颞叶 (验证情景-语义协同)',
        enable_hippocampus=False,
        enable_temporal_lobe=False,
        enable_kg=False
    ),

    'no_amygdala_prefrontal': AblationConfig(
        name='no_amygdala_prefrontal',
        description='禁用杏仁核+前额叶 (验证情感-执行协同)',
        enable_amygdala=False,
        enable_prefrontal=False,
        enable_salience=False
    ),

    'no_kg_story_arc': AblationConfig(
        name='no_kg_story_arc',
        description='禁用KG+StoryArc (验证结构化知识协同)',
        enable_kg=False,
        enable_story_arc=False
    ),
