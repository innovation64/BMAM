...
from ...utils.token_utils import estimate_tokens as _fallback_estimate
from ...core.constants import DEFAULT_TOKENIZER_MODEL
...
5. Prepare information for downstream processing"""
        ...
        try:
            ...
            logger.warning(
                f"Failed to load {DEFAULT_TOKENIZER_MODEL} encoding:"
                f" {e}, using cl100k_base"
            )
