...
class OpenAIEmbeddingService:
    ...
    def __init__(self, use_cache: bool = True):
        ...
        self.model = get_env("EMBEDDING_MODEL", DEFAULT_EMBEDDING_MODEL)
        self.dimension = int(get_env(
            "EMBEDDING_DIMENSION", str(DEFAULT_EMBEDDING_DIMENSION)
        ))
        self.max_length = int(get_env(
            "EMBEDDING_MAX_LENGTH", str(DEFAULT_EMBEDDING_MAX_LENGTH)
        ))
